...
const convenioHonorariosValidation = z.object({
    ...
    apoderado: z.string()
        .min(1, { message: "El nombre del apoderado no puede estar vacio." })
        .max(40, { message: "El nombre del apoderado no puede superar los 40 caracteres." }),
    representado: z.string()
        .min(1, { message: "El nombre del representado no puede estar vacio." })
        .max(40, { message: "El nombre del representado no puede superar los 40 caracteres." }),
    ...
    sumaIndemnizacionTexto: z.string()
        ...
        .max(50, { message: "El texto de lugar de la suma de la indemnizacion no puede superar los 50 caracteres." }),
    porcentaje: z.string()
        .min(1, { message: "El porcentaje de honorarios no puede estar vacio." })
        .regex(/^\d{1,3}(\.\d{1,2})?$/, {
            message: "Formato invalido de porcentaje",
        })
})

export default convenioHonorariosValidation;
